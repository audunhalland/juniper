...
impl<S> MetaType<S> {
    ...
    pub fn as_type(&self) -> Type<ArcStr> {
        match *self {
            MetaType::Scalar(ScalarMeta { ref name, .. })
            | MetaType::Object(ObjectMeta { ref name, .. })
            | MetaType::Enum(EnumMeta { ref name, .. })
...
impl ListMeta {
    ...
    pub fn new(of_type: Type<ArcStr>, expected_size: Option<usize>) -> Self {
        Self {
            of_type,
            expected_size,
        }
...
impl NullableMeta {
    ...
    pub fn new(of_type: Type<ArcStr>) -> Self {
        Self { of_type }
    }
...
impl<S> ObjectMeta<S> {
    ...
    #[must_use]
    pub fn interfaces(mut self, interfaces: &[Type<ArcStr>]) -> Self {
...
impl UnionMeta {
    ...
    /// [`Type`]s.
    pub fn new(name: ArcStr, of_types: &[Type<ArcStr>]) -> Self {
        Self {
            name,
            description: None,
...
impl<S> Argument<S> {
    ...
    pub fn new(name: ArcStr, arg_type: Type<ArcStr>) -> Self {
        Self {
            name,
            description: None,
            arg_type,
